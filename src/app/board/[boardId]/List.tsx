...
return (
  <div ref={setNodeRef} className="flex flex-col w-full h-fit max-h-full p-2 bg-gray-200 rounded-lg shadow dark:bg-gray-800">
  <div className="flex justify-between items-center p-2 mb-2">
    {isEditing ? (
      <div className="flex items-center gap-2 w-full">
        ...
        <div className="flex items-center">
          <button onClick={handleSaveListTitle} className="p-1 text-green-600 hover:text-green-500">
            <Save size={18} />
          </button>
          <button onClick={() => setIsEditing(false)} className="p-1 text-red-600 hover:text-red-500">
            <X size={18} />
          </button>
        </div>
      </div>
    ...
    <div className="flex items-center gap-1">
      ...
      <button onClick={() => onDeleteList(list.id)} className="p-1 text-gray-500 hover:text-red-600">
        <Trash2 size={16} />
      </button>
    </div>
  </div>
