      ...
      {isEditing ? (
        <div className='flex flex-col gap-2'>
            ...
            <div className="flex justify-end gap-2">
                <button onClick={() => setIsEditing(false)} className="px-2 py-1 text-xs text-gray-600 rounded-md hover:bg-gray-200 dark:text-gray-300 dark:hover:bg-gray-600">Cancel</button>
                <button onClick={handleSave} className="px-2 py-1 text-xs text-white bg-green-600 rounded-md hover:bg-green-700">Save</button>
            </div>
        </div>
      ) : (
        <div>
