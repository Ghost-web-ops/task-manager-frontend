  ...
  >
    {isEditing ? (
      ...
      <div>
        ...
        <div className="absolute top-1 right-1 flex items-center gap-1 opacity-0 group-hover:opacity-100 md:group-hover:opacity-100 transition-opacity md:transition-opacity">
